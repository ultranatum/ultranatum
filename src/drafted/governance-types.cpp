...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "UltranatumNetwork") type = UltranatumNetwork;
    if(strType == "UltranatumNetworkVariable") type = UltranatumNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == UltranatumNetwork) s = "UltranatumNetwork";
    if(type == UltranatumNetworkVariable) s = "UltranatumNetworkVariable";
