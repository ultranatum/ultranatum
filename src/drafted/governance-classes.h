 ...
 *
 *   // network
 *   CUltranatumNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.ultranatum.site/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CUltranatumNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CUltranatumNetwork(UniValue objIn)
    {
...
// // can be under: UltranatumNetwork
// //   -- signature requirements : Key1(User)
// class CUltranatumNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == UltranatumNetwork);
//     // }
