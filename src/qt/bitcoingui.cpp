    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Ultranatum Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ultranatum address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ultranatum: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Ultranatum Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ultranatum Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ultranatum Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ultranatum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ultranatum addresses"));
    ...
    openAction->setStatusTip(tr("Open a ultranatum: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ultranatum Core help message to get a list with possible Ultranatum Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Ultranatum Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ultranatum network", "", count));
}
...
{
    QString strTitle = tr("Ultranatum Core"); // default title
    ...
    // Append title to "Ultranatum Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
