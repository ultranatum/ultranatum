    ...
    mapper(0)
{
    ...
    /* Theme selector */
    /*ui->theme->addItem(QString("ULTRA-light"), QVariant("light"));*/
    ui->theme->addItem(QString("ULTRA-blue"), QVariant("drkblue"));
    /*ui->theme->addItem(QString("ULTRA-Crownium"), QVariant("crownium"));*/
    ui->theme->addItem(QString("ULTRA-traditional"), QVariant("trad"));
