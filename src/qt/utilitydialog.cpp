    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Ultranatum Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Ultranatum Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  ultranatum-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Ultranatum in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ULTRA, 0.1 ULTRA, 1 ULTRA and 10 ULTRA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://ultranatumcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://ultranatumcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Ultranatum Core is shutting down...") + "<br /><br />" +
