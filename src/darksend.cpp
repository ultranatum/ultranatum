...
{
    if(fLiteMode) return; // ignore all Ultranatum related functionality
...
/*
    ...
    allow endless transaction that would bloat Ultranatum and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("ultranatum-privatesend");
