...
2. run ultranatumd with -printalert or -sendalert like this:
   /path/to/ultranatumd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.ultranatum.site";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Ultranatum Core:0.12.0.58/"));
