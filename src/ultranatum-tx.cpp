...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Ultranatum Core ultranatum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ultranatum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ultranatum transaction") + "\n" +
              "  ultranatum-tx [options] -create [commands]   " + _("Create hex-encoded ultranatum transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ultranatum transaction
