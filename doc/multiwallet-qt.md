...
Only requiring some minor changes is ultranatum.cpp.
...
Changes to ultranatum.cpp
----------------------
ultranatum.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
