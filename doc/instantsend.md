...
This mechanism has been integrated into Bitcore-Node-Ultranatum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ultranatumcoin/insight-api-ultranatum#web-socket-api](https://github.com/ultranatumcoin/insight-api-ultranatum#web-socket-api) 
* API: [https://github.com/ultranatumcoin/insight-api-ultranatum#instantsend-transactions](https://github.com/ultranatumcoin/insight-api-ultranatum#instantsend-transactions) 
...
By default, the Ultranatum Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ultranatum Core daemon:
