...
Ultranatum Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Ultranatum Core, where everyone uses
...
pay attention to for reviewers of Ultranatum Core code.

General Ultranatum Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Ultranatum Core uses tinyformat, which is type safe. Leave them out to avoid confusion
